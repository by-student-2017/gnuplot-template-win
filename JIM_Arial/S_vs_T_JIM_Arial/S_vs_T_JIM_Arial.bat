...
rem graph environment 
 ...
 echo set ytics 20 offset 0.3,0.0			>> env.txt
 rem echo set yrange[0:500]				>> env.txt
 echo set ylabel "Seebeck Coefficient, {/%font%:Italic S} ({/Symbol m}V/K)" offset 1.5,0.0	>> env.txt
