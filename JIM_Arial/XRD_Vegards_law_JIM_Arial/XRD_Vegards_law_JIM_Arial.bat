...
if exist *.dat2 (goto next3)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w p pt %marker_data1% ps %point_size% lc "%color_data1%" 	>> env.txt
 goto end

:next3
if exist *.dat3 (goto next4)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w p pt %marker_data1% ps %point_size% lc "%color_data1%",^
