...
rem line type
 ...
 set line_type_data4=0
 set line_type_data5=0
 set line_type_data6=0
...
rem graph environment 
 ...
 echo set label 1 at graph 0.35,0.10 %label1_compsition%	>> env.txt
 echo set label 2 at graph 0.05,0.9 %label2_temperature%	>> env.txt
