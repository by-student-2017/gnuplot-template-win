...
rem graph environment 
 ...
 echo set size 0.58,1.0					>> env.txt
 echo set key title %compsition%			>> env.txt
 echo set key right top					>> env.txt
 echo #label setting 					>> env.txt
 echo set label 1 at graph 0.50,0.93 %label1_compsition%	>> env.txt
 echo set label 2 center at first 26.5,graph 0.55 "111" rotate by 90	>> env.txt
 echo set label 3 center at first 30.5,graph 0.52 "200" rotate by 90	>> env.txt
 echo set label 4 center at first 41.0,graph 0.60 "220" rotate by 90	>> env.txt
 echo set label 5 center at first 52.0,graph 0.53 "311" rotate by 90	>> env.txt
 echo set label 6 center at first 56.0,graph 0.50 "222" rotate by 90	>> env.txt
 echo set label 7 center at first 61.5,graph 0.60 "400" rotate by 90	>> env.txt
 echo #label setting 					>> env.txt
 echo set label 11 center at first 26.5,graph 0.69 "L2_{1}"	>> env.txt
 echo set label 12 center at first 31.0,graph 0.62 "B2"	>> env.txt
 echo set label 13 center at first 49.0,graph 0.80 "BCC"	>> env.txt
 echo #label setting 
 echo set label 21 left at second 20.2,graph 0.10 "{/%font%:Italic x}=0" font "%font%,12"	>> env.txt					>> env.txt
 echo set label 22 left at second 20.2,graph 0.22 "0.01" font "%font%,12"	>> env.txt
 echo set label 23 left at second 20.2,graph 0.34 "0.02" font "%font%,12"	>> env.txt
 echo set label 24 left at second 20.2,graph 0.46 "0.03" font "%font%,12" 	>> env.txt
 echo #label setting 					>> env.txt
 echo set label 30 left at second 23.0,graph 0.91 "*" font "%font%,24"	>> env.txt
 echo set label 31 left at second 26.0,graph 0.91 "FeTa"	>> env.txt
 echo set label 32 left at second 33.2,graph 0.44 "*" font "%font%,24"	>> env.txt
 echo set label 33 left at second 38.2,graph 0.44 "*" font "%font%,24"	>> env.txt
 echo set label 34 left at second 40.5,graph 0.44 "*" font "%font%,24"	>> env.txt
 echo #graph setting 					>> env.txt
 echo set terminal wxt font "%font%,14"			>> env.txt
 echo set mxtics 2					>> env.txt
 echo set xtics 10 offset 0.0,0.25			>> env.txt
 echo set xlabel "2{/Symbol:Italic q} (degree)" offset 0.0,0.70	>> env.txt
 echo set xrange[20:70]					>> env.txt
 echo set noytics					>> env.txt
 echo set yrange[0:%int_offset%*8]		>> env.txt
 echo set format y ""					>> env.txt
 echo set ylabel "Intensity, {/%font%:Italic I} (arb. units)" offset 0.0,0.0	>> env.txt
...
if exist *.dat2 (goto next3)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w l lt %line_type_data1% lw %line_wide% lc "%color_data1%" >> env.txt
 goto end

:next3
if exist *.dat3 (goto next4)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% w l lt %line_type_data2% lw %line_wide% lc "%color_data2%"  >> env.txt
 goto end

:next4
if exist *.dat4 (goto next5)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% w l lt %line_type_data2% lw %line_wide% lc "%color_data2%",^
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% w l lt %line_type_data3% lw %line_wide% lc "%color_data3%" 	>> env.txt
 goto end
...
if exist *.dat5 (goto next6)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% w l lt %line_type_data2% lw %line_wide% lc "%color_data2%",^
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% w l lt %line_type_data3% lw %line_wide% lc "%color_data3%",^
  "data.dat4" u %x%:($%y%+%int_base%+%int_offset%*3) t %name_data4% w l lt %line_type_data4% lw %line_wide% lc "%color_data4%"	>> env.txt
 goto end
...
if exist *.dat6 (goto next7)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% w l lt %line_type_data2% lw %line_wide% lc "%color_data2%",^
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% w l lt %line_type_data3% lw %line_wide% lc "%color_data3%",^
  "data.dat4" u %x%:($%y%+%int_base%+%int_offset%*3) t %name_data4% w l lt %line_type_data4% lw %line_wide% lc "%color_data4%",^
  "data.dat5" u %x%:($%y%+%int_base%+%int_offset%*4) t %name_data5% w l lt %line_type_data5% lw %line_wide% lc "%color_data5%" >> env.txt
 goto end
...
if exist *.dat7 (goto next8)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  ...
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% w l lt %line_type_data3% lw %line_wide% lc "%color_data3%",^
  "data.dat4" u %x%:($%y%+%int_base%+%int_offset%*3) t %name_data4% w l lt %line_type_data4% lw %line_wide% lc "%color_data4%",^
  "data.dat5" u %x%:($%y%+%int_base%+%int_offset%*4) t %name_data5% w l lt %line_type_data5% lw %line_wide% lc "%color_data5%",^
  "data.dat6" u %x%:($%y%+%int_base%+%int_offset%*5) t %name_data6% w l lt %line_type_data6% lw %line_wide% lc "%color_data6%" 	>> env.txt
 goto end
:next8
:end
