...
rem composition
 set compsition="Fe_{1.97}V_{1.03+{/%font%:Italic x}}Al_{1-{/%font%:Italic x}}"
...
rem graph environment 
 ...
 echo set ytics 100 offset 0.3,0.0			>> env.txt
 echo set yrange[0:*]					>> env.txt
 echo set ylabel "Electrical Resistivity, {/Symbol:Italic r} ({/Symbol mW}cm)" offset 1.5,0.0	>> env.txt
