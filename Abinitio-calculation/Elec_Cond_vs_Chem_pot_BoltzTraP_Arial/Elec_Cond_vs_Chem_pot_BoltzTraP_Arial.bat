...
rem composition
 set compsition="Fe_{2}V_{1.09-{/%font%:Italic x}}Al_{0.91+{/%font%:Italic x}}"
 set label1_compsition=""
 set label2_temperature="10 K"
...
rem graph environment 
 ...
 echo set size 0.9,1.0					>> env.txt
 echo set key title %compsition%			>> env.txt
 echo set key left top					>> env.txt
 echo set label 1 at graph 0.05,0.90 %label1_compsition%	>> env.txt
 echo set label 2 at graph 0.88,0.93 %label2_temperature%	>> env.txt
 echo set terminal wxt font "%font%,14"			>> env.txt
 echo set mxtics 2					>> env.txt
 echo set xtics 1 offset 0.0,0.25			>> env.txt
 echo set xlabel "Chemical Potential, {/Symbol:Italic m} / eV" offset 0.0,0.70	>> env.txt
 echo set xrange[-2:2]				>> env.txt
 echo set mytics 2					>> env.txt
 echo set ytics 2 offset 0.3,0.0			>> env.txt
 echo set yrange[0:12]					>> env.txt
 echo set ylabel "Electrical Conductivity, {/Symbol:Italic s}/{/Symbol:Italic t} / 10^{22} {/Symbol W}^{-1}m^{-1}s^{-1}" offset 1.5,0.0	>> env.txt
...
if exist *.dat2 (goto next3)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% smooth csplines w l lt %line_type_data1% lw %line_wide% lc "%color_data1%" >> env.txt
 goto end

:next3
if exist *.dat3 (goto next4)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% smooth csplines w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% smooth csplines w l lt %line_type_data2% lw %line_wide% lc "%color_data2%"  >> env.txt
 goto end

:next4
if exist *.dat4 (goto next5)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% smooth csplines w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% smooth csplines w l lt %line_type_data2% lw %line_wide% lc "%color_data2%",^
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% smooth csplines w l lt %line_type_data3% lw %line_wide% lc "%color_data3%" 	>> env.txt
 goto end
...
if exist *.dat5 (goto next6)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% smooth csplines w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% smooth csplines w l lt %line_type_data2% lw %line_wide% lc "%color_data2%",^
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% smooth csplines w l lt %line_type_data3% lw %line_wide% lc "%color_data3%",^
  "data.dat4" u %x%:($%y%+%int_base%+%int_offset%*3) t %name_data4% smooth csplines w l lt %line_type_data4% lw %line_wide% lc "%color_data4%"	>> env.txt
 goto end
...
if exist *.dat6 (goto next7)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% smooth csplines w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  "data.dat2" u %x%:($%y%+%int_base%+%int_offset%*1) t %name_data2% smooth csplines w l lt %line_type_data2% lw %line_wide% lc "%color_data2%",^
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% smooth csplines w l lt %line_type_data3% lw %line_wide% lc "%color_data3%",^
  "data.dat4" u %x%:($%y%+%int_base%+%int_offset%*3) t %name_data4% smooth csplines w l lt %line_type_data4% lw %line_wide% lc "%color_data4%",^
  "data.dat5" u %x%:($%y%+%int_base%+%int_offset%*4) t %name_data5% smooth csplines w l lt %line_type_data5% lw %line_wide% lc "%color_data5%" >> env.txt
 goto end
...
if exist *.dat7 (goto next8)
 echo plot "data.dat1" u %x%:($%y%+%int_base%) t %name_data1% smooth csplines w l lt %line_type_data1% lw %line_wide% lc "%color_data1%",^
  ...
  "data.dat3" u %x%:($%y%+%int_base%+%int_offset%*2) t %name_data3% smooth csplines w l lt %line_type_data3% lw %line_wide% lc "%color_data3%",^
  "data.dat4" u %x%:($%y%+%int_base%+%int_offset%*3) t %name_data4% smooth csplines w l lt %line_type_data4% lw %line_wide% lc "%color_data4%",^
  "data.dat5" u %x%:($%y%+%int_base%+%int_offset%*4) t %name_data5% smooth csplines w l lt %line_type_data5% lw %line_wide% lc "%color_data5%",^
  "data.dat6" u %x%:($%y%+%int_base%+%int_offset%*5) t %name_data6% smooth csplines w l lt %line_type_data6% lw %line_wide% lc "%color_data6%" 	>> env.txt
 goto end
:next8
:end
