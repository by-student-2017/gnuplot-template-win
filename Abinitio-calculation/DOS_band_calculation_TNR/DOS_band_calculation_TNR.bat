...
rem graph environment 
 ...
 echo set xtics 2 offset 0.0,0.25			>> env.txt
 echo set xlabel "Energy, {/Symbol:Italic e} / eV" offset 0.0,0.70	>> env.txt
 echo set xrange[-12:4]				>> env.txt
 echo set mytics 2					>> env.txt
 echo set ytics 2 offset 0.3,0.0			>> env.txt
 echo set yrange[0:12]					>> env.txt
 echo set ylabel "DOS, {/%font%:Italic N}({/Symbol:Italic e}) eV^{-1}unitcell^{-1}" offset 1.5,0.0	>> env.txt
