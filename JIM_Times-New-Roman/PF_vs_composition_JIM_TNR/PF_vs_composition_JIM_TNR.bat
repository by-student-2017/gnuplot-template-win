...
rem graph environment 
 ...
 echo set label 1 at graph 0.40,0.1 %label1_compsition%	>> env.txt
 ...
 echo set ytics 1 offset 0.3,0.0			>> env.txt
 echo set yrange[0:*]					>> env.txt
 echo set ylabel "Power Factor, {/%font%:Italic P} (10^{-3}W/mK^{2})" offset 1.5,0.0	>> env.txt
