...
rem graph environment 
 ...
 echo #label setting 
 echo set label 21 left at second 20.7,graph 0.10 "{/%font%:Italic x}=0" font "%font%,12"	>> env.txt					>> env.txt
 echo set label 22 left at second 20.7,graph 0.22 "0.01" font "%font%,12"	>> env.txt
 echo set label 23 left at second 20.7,graph 0.34 "0.02" font "%font%,12"	>> env.txt
 echo set label 24 left at second 20.7,graph 0.46 "0.03" font "%font%,12" 	>> env.txt
 echo #label setting 					>> env.txt
 ...
 echo set label 32 left at second 33.2,graph 0.45 "*" font "%font%,24"	>> env.txt
 echo set label 33 left at second 38.2,graph 0.45 "*" font "%font%,24"	>> env.txt
 echo set label 34 left at second 40.5,graph 0.45 "*" font "%font%,24"	>> env.txt
 echo #graph setting 					>> env.txt
