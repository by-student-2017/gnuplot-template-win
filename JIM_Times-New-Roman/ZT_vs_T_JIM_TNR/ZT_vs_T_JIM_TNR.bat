...
rem graph environment 
 ...
 echo set label 1 at graph 0.45,0.93 %label1_compsition%	>> env.txt
 ...
 echo set mytics 4					>> env.txt
 echo set ytics 0.1 offset 0.3,0.0			>> env.txt
 echo set yrange[0:*]				>> env.txt
 echo set ylabel "Dimentionless Figure of Merit, {/%font%:Italic ZT}" offset 1.5,0.0	>> env.txt
